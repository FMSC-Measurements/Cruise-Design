namespace CruiseDesign.Strata_setup
{
   partial class TDV_Select
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.selectedItemsGridView1.Margin = new System.Windows.Forms.Padding(2, 2, 2, 2);
         ...
         this.chargeableDataGridViewTextBoxColumn.ToolTipText = "Chargeable or Non-Chargeable";
