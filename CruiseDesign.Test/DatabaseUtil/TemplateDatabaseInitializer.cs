...
namespace CruiseDesign.Test.DatabaseUtil
{
    public class TemplateDatabaseInitializer
    {
        ...
        public CruiseDAL.V3.Models.Reports[] Reports { get; set; }
        ...
        public TemplateDatabaseInitializer()
        {
            ...
            Reports = new[]
            {
                new CruiseDAL.V3.Models.Reports {ReportID = "A1", Selected =  true},
                new CruiseDAL.V3.Models.Reports {ReportID = "A2", Selected =  true},
            };
