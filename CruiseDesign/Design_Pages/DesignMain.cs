...
namespace CruiseDesign.Design_Pages
{
    public partial class DesignMain : Form
    {
        ...
        public DesignMain(ICruiseDesignFileContextProvider contextProvider, IServiceProvider serviceProvider)
        {
            ...
            //textBoxCost.Text = "0";
            reconFilePath = fileContext.ReconFilePath;
        }
        ...
        private void buttonFScruiser_Click(object sender, EventArgs e)
        {
            ...
            CreateProduction pDlg = ServiceProvider.GetRequiredService<CreateProduction>();
